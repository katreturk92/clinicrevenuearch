...
        <p style={{ margin: '0 0 16px 0', color: '#64748b', fontSize: '14px' }}>Missing Supabase environment variables</p>
        <p style={{ margin: 0, color: '#94a3b8', fontSize: '12px' }}>Please check your Vercel environment settings</p>
      </div>
    </div>
  )
...
            {noServices ? (
              <p style={{ color: '#64748b', textAlign: 'center', padding: '20px' }}>No services yet. Add your first service above.</p>
            ) : (
              <div style={{ background: 'white', borderRadius: '12px', padding: '24px', boxShadow: '0 1px 3px rgba(0,0,0,0.1)' }}>
